...
const Item = function(props) {
    const { code, name, address, version, model_version, url } = props
    ...
    return <div className="col-md-12">
        <div className="panel panel-default">
            <div className="panel-body">
                ...
                {model_version!='' &&
                    <p className="pull-right">Доступная версия модели: <span className="label label-success">{model_version}</span></p>
                }
            </div>
        </div>
    </div>
